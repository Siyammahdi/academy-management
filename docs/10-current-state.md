...
| Class link | ✅ | Field on `Batch`, manager-editable |
...
| Reporting + CSV export | — | ⛔ No revenue, outstanding, ledger, or export endpoints |
| Role-management endpoint | RBAC | ⛔ Roles assigned only through Prisma Studio |
