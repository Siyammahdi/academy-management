  ...
  return (
    <div className="flex min-w-0 flex-col gap-6">
      <AdminPageHeader
        eyebrow="Account"
        title="Profile"
        description="Who you are in An Nahda — email, roles, and linked student id if any. Password changes use the public reset flow."
        actions={
          <Button
            variant="outline"
            className="min-h-11"
          ...
          <dl className="grid gap-4 sm:grid-cols-2">
            ...
            <div className="space-y-1">
              ...
              <dd className="text-sm text-foreground">
                {user.studentId ?? 'None — owner accounts usually have no student profile'}
              </dd>
            </div>
          </dl>
        </div>
