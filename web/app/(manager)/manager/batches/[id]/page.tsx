...
/**
 * Manager batch workspace — Overview
 * Read-only ops snapshot for an assigned batch. No fee/status/manager edits.
 */
export default function ManagerBatchOverviewPage() {
          ...
          batch ? (
            <>
              <Button
                className="min-h-11"
                render={
                  <Link href={`/manager/batches/${batchId}/classroom`} />
                }
              >
                <LinkIcon />
                Classroom
              ...
              <Button
                variant="secondary"
                className="min-h-11"
                render={<Link href={`/manager/batches/${batchId}/roster`} />}
              >
                <UsersIcon />
                Roster
              </Button>
        ...
        <>
            ...
            <div className="flex flex-col gap-2">
              {!batch.classLink ? (
                <AttentionRow
                  ...
                  href={`/manager/batches/${batchId}/classroom`}
                  action="Set link"
                  icon={LinkIcon}
                />
              ) : null}
              {counts.penalty > 0 ? (
                <AttentionRow
                  ...
                  href={`/manager/batches/${batchId}/roster`}
                  action="Open roster"
          ...
          <section className="rounded-xl bg-muted/50 p-5">
            ...
            <p className="mt-1 text-sm text-muted-foreground">
              Other managers assigned to this batch (read-only).
            </p>
            {batch.managers.length === 0 ? (
              <p className="mt-4 text-sm text-muted-foreground">
                No managers listed on this batch yet.
              </p>
            ) : (
              <ul className="mt-4 flex flex-col gap-2">
