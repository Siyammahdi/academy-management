...
interface TeacherFocusCardProps {
  focus: TeacherFocus
}

export function resolveTeacherFocus(input: {
...
export function TeacherFocusCard({ focus }: TeacherFocusCardProps) {
  if (focus.kind === 'clear') {
    return (
    ...
    return (
      <div className="relative flex h-full flex-col justify-between overflow-hidden rounded-xl bg-primary-wash p-5 sm:p-6">
        ...
        <div className="mt-6 flex flex-wrap gap-2 pl-2">
          <Button
            className="min-h-11 w-full sm:w-auto"
            render={<Link href="/teacher/class-links" />}
          >
            <LinkIcon />
            Update class links
          </Button>
